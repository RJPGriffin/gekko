...
var strat = {
  ...
  init: function() {
    ...
    log.info("ADX: " + this.settings.ADX);
    log.info("Sell_Offset: " + this.settings.Sell_Offset);
    log.info("Buy_Offset: " + this.settings.Buy_Offset);
    log.info("Sell_ADX_Modifier: " + this.settings.Sell_ADX_Modifier);
    log.info("Buy_ADX_Modifier: " + this.settings.Buy_ADX_Modifier);
  ...
  check: function() {
    ...
    if (adx !== undefined) {
      ...
      if (this.trend === 'bull') {
        ...
        // let newStop = this.periodMax - (atr * this.settings.Sell_Offset + atr * (100 / (adx * this.settings.Sell_ADX_Modifier)));
        // let newStop = this.periodMax - (atr * this.settings.Sell_Offset) + atr * Math.pow((1 + adx / 100), ((1 + adx / 100) * this.settings.Sell_ADX_Modifier));
        let newStop = this.periodMax - (atr * this.settings.Sell_Offset) + atr * (adx / 100) * this.settings.Sell_ADX_Modifier;
        //            average high  -    range * multiplier   + range * adx(0-1) * adx multiplier
        ...
        //let newStop = this.periodMin + (atr + atr * adx * this.settings.ADX_Multiplier_Bear);
        // let newStop = this.periodMin + (atr * this.settings.Buy_Offset + atr * (100 / (adx * this.settings.Buy_ADX_Modifier)));
